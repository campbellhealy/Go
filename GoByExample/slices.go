...
func main() {
	...
	// length, use the builtin make. Here we make a slice of strings of length
	...
	// that make them richer than arrays. One is the builtin append, which
	// returns a slice containing one or more new values. Note that we need
